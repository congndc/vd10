...
using vd10.Models;
using vd10.Repository;

namespace vd10.Controllers
{
    public class EnrollmentsController : Controller
    {
        private readonly NewContext _context;

        public EnrollmentsController(NewContext context)
        {
            _context = context;
        }
        ...
        {
            var newContext = _context.Enrollment.Include(e => e.Course).Include(e => e.Student);
        ...
        public IActionResult Create()
        {
            ...
            ViewData["StudentID"] = new SelectList(_context.Student, "StudentID", "FisrtName");
            return View();
        }
