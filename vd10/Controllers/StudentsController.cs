...
namespace vd10.Controllers
{
    public class StudentsController : Controller
    {
        ...
        {
            var newContext = _context.Student.Include(s => s.Gender);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StudentID,FisrtName,LastName,DOB,GenderID,RegistrationDate,Status")] Student student)
        {
